...
/**
 * <p>
 * A {@code SpeechletV2} is a com.amazon.speech-enabled web service that runs in the cloud. A
 * {@code SpeechletV2} receives and responds to com.amazon.speech initiated requests.
 * </p>
 *
 * <p>
 ...
 * as experienced by the user interacting with the com.amazon.speech enabled device. A single
...
public interface SpeechletV2 {
    ...
    /**
     * Entry point for {@code SpeechletV2}s for handling a com.amazon.speech initiated request to start the skill
