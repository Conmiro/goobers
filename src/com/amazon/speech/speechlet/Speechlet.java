...
/**
 * <p>
 * A {@code Speechlet} is a com.amazon.speech-enabled web service that runs in the cloud. A {@code Speechlet}
 * receives and responds to com.amazon.speech initiated requests.
 * </p>
 *
 * <p>
 ...
 * <li>a way to service com.amazon.speech requests from the user</li>
 ...
 * experienced by the user interacting with the com.amazon.speech enabled device. A single {@code Speechlet}
...
public interface Speechlet {
    ...
    /**
     * Entry point for {@code Speechlet}s for handling a com.amazon.speech initiated request to start the skill
    ...
    /**
     * Entry point for handling com.amazon.speech initiated requests.<br>
     *
