...
public class SpeechletResponse {
    ...
    /**
     * Returns the com.amazon.speech associated with this response.
     *
     * @return the com.amazon.speech
     */
    ...
    /**
     * Sets the com.amazon.speech associated with this response.
     *
     * @param outputSpeech
     *            the com.amazon.speech to set
     */
     ...
     *
     * @param outputSpeech
     *            output com.amazon.speech content for the tell voice response
    ...
    /**
     * Creates and returns a response intended to tell the user something, both in com.amazon.speech and with a
     ...
     *
     * @param outputSpeech
     *            output com.amazon.speech content for the ask voice response
     * @param reprompt
     *            reprompt com.amazon.speech for the ask voice response. This com.amazon.speech is played if the user does
    ...
    /**
     * Creates and returns a response intended to ask the user a question, both in com.amazon.speech and with a
