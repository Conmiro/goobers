 ...
 * function.
 */
public class SpeechletRequestStreamHandler extends com.amazon.speech.speechlet.lambda.SpeechletRequestStreamHandler {
    ...
    public SpeechletRequestStreamHandler() {
        super(new GoobersSpeechlet(), supportedApplicationIds);
    }

    public SpeechletRequestStreamHandler(Speechlet speechlet,
